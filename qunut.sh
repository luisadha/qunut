...
### <a name="usage" href="#usage">INSTALL</a></h2><pre><code code="shell">gh repo clone luisadha/weapon-url-opener</code></pre><h3>
### <a name="code" href="#code">CODE</a></h2><pre><code code="bash">
#Author:  Luis Adha
# This code is released to the public domain.
# The author gave permission to use this code snippet in your script. # Script name: qunut.sh # Version: v0.1 # Build date: Thu Dec 16 13:19:21 WIB 2021
# Info : 39 Lines, 3 Pages.
more $0

: BEGIN
# To memorize Surah Qunut /UNTUK MENGHAFAL QUNUT (type: q for Quit/keluar)
: Days 1st /Hari ke-1
## Allaahummahdinii fii man hadaiit, wa 'aafinii fii man 'aafaiit,
